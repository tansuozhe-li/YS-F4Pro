...
{
    //HAL_UART_Error_ORE_Handle(&hlpuart1);
    //HAL_UART_Error_ORE_Handle(&huart4);
    //HAL_UART_Error_ORE_Handle(&huart5);
    //HAL_UART_Error_ORE_Handle(&huart1);
    //HAL_UART_Error_ORE_Handle(&huart2);
    //HAL_UART_Error_ORE_Handle(&huart3);
    //HAL_UART_Error_ORE_Handle(&huart6);
}
