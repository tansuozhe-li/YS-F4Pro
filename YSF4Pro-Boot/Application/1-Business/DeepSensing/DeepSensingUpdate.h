...
#define UPDATE_BOOTLOADER_ADDR_END     (0x0801FFFF)  //片内Bootloader结束地址，共96KB，Bank1: Sector0-Sector2
//应用程序包头存储地址信息--片内
#define UPDATE_APP_PKG_HEAD_BEGIN      (0x08020000)  //片内应用程序包头起始地址
#define UPDATE_APP_PKG_HEAD_END        (0x0803FFFF)  //片内应用程序包头结束地址，共32KB, Bank1: Sector3
#define UPDATE_APP_PKG_HEAD            ((UpdateFileHead*)UPDATE_APP_PKG_HEAD_BEGIN)
/* 应用程序地址信息--片内Flash */
#define UPDATE_APP_ADDR_BEGIN          (0x08040000)  //片内应用程序起始地址
#define UPDATE_APP_ADDR_END            (0x080FFFFF)  //片内应用程序结束地址，共384kB，Bank1:Page64 -Page255
